...
public class PdfReport {
    ...
    private static final Font TITLE_FONT = new Font(Font.FontFamily.UNDEFINED, 20, Font.NORMAL);
    private static final Font HEADER_FONT = new Font(Font.FontFamily.HELVETICA, 12, Font.NORMAL);
